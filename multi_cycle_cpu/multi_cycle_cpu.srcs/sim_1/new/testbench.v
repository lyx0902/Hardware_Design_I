...
module testbench;
    ...
    begin
      ...
      begin
       ...
       if(WB_pc==32'h00000048)
       begin
                 rf_addr=17;
                 #5;
       end
       if(WB_pc==32'h0000004c)
       begin
                 rf_addr=18;
                 #5;
       end
       if(WB_pc==32'h00000050)
       begin
                 rf_addr=19;
                 #5;
       end
       if(WB_pc==32'h00000054)
       begin
                 rf_addr=20;
                 #5;
       end
       if(WB_pc==32'h00000058)
       begin
                 rf_addr=20;
                 #5;
       end
       if(WB_pc==32'h0000005c)
       begin
                 mem_addr=32'h00000008;
                 #5;
       end
       if(WB_pc==32'h00000060)
       begin
                 rf_addr=21;
                 #5;
       end
       if(WB_pc==32'h00000064)
       begin
                 mem_addr=32'h00000012;
                 #5;
       end
